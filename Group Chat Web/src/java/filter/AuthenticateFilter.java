...
public class AuthenticateFilter implements Filter {
    ...
    private static List<String> requiredList = new ArrayList(){{
        add("/home");
        add("/signout");
        add("/base");
        add("/getInformation");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean check = req.getSession().getAttribute("username") != null;
        
        if(requiredList.contains(path)){
            if(check){
        ...
        else if(path.equals("/signin")||path.equals("/register")){
           if(check) {
